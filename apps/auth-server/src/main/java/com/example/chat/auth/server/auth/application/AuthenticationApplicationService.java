package com.example.chat.auth.server.auth.application;
...
import com.example.chat.auth.server.auth.domain.*;
import com.example.chat.auth.server.auth.domain.credential.Device;
import com.example.chat.auth.server.auth.domain.policy.AuthPolicy;
...
import com.example.chat.auth.server.auth.domain.service.CredentialAuthenticationEngine;

...
import com.example.chat.auth.server.rest.dto.factory.CredentialFactory;
import com.example.chat.auth.server.rest.dto.request.AuthenticateRequest;
import com.example.chat.auth.server.rest.dto.request.CompleteMfaRequest;
import com.example.chat.auth.server.rest.dto.request.SignupRequest;
import com.example.chat.auth.server.rest.dto.response.AuthResponse;
import com.example.chat.auth.server.rest.dto.response.SignupResponse;
import com.example.chat.auth.server.auth.application.AuthenticationApplicationService;
import com.example.chat.auth.server.mfa.application.MfaApplicationService;
import com.example.chat.auth.server.signup.application.SignupApplicationService;
